...
def _legacy(model, root):
    ...
    if data:
        allowed = ('日期','date','路','来源','结论','五路裁决','总裁决','检查四项','分歧裁决','综合深挖','认知迭代','线索跟踪','指派清单','schema_version','昨日战绩验收','环境加权依据','页面合同') if route=='index' else ('日期','date','路','来源','判断','荐票','认知迭代','认知迭代_条目','深挖')
