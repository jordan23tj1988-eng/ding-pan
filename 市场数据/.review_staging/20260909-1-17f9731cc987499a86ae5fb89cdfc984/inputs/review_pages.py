...
HEADING_MAP = {
 'index': [('总判断','observations'),('核心观察','observations'),('环境','observations'),('题材树','observations'),('周期与攻防','turning'),('五路看牌','routes'),('五路','routes'),('明日观察','turning'),('拐点预警','turning'),('拐点','turning'),('检查四项','turning'),('发布门禁','turning'),('推演指派','master'),('总裁决','verdict'),('Master','master'),('深挖','master'),('认知','master'),('指派','master')],
