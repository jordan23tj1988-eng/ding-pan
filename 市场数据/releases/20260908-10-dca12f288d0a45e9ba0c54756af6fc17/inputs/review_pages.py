...
@media(max-width:640px){.reading-spine{align-items:flex-start}.reading-spine .rs-arrow{display:none}.reading-spine .rs-step{flex:1;min-width:132px;justify-content:center}.claim-proof{line-height:1.8}.navbar{align-items:flex-start}.navbar .pills{flex:1 1 100%;width:auto;max-width:100%;min-width:0;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));overflow:visible;row-gap:3px}.navbar .pills a{min-width:0;text-align:center}.navbar .upd{flex:0 0 auto}}
'''
