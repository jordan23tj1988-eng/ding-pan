...
def r_judge(body):
    ...
    # ★2026-09-04 修复: rest 剥离 SEATCARD 段时保留其前的 sec 包裹开放 div(h2一与SEATCARD之间的
    #   <div class="sec sec-scan"><div class="sec-body">), 否则仅剩尾部 </div></div> 造成 -2 div 失衡(C6)
    prefix = body[e + 5:s] if (s >= 0 and s > e) else ''
