---
name: "taste-skill"
description: "Anti-slop前端设计品味技能(Leonxlnx/taste-skill v2原版)。构建落地页/作品集/官网重设计、或用户提到\"taste/设计品味/anti-slop/别做得像AI模板\"时使用。核心:先读brief推断设计方向→设三个旋钮(VARIANCE/MOTION/DENSITY)→选真实设计系统→禁AI套路(紫渐变/三等卡片/Inter默认/em-dash)→出货前跑Pre-Flight清单。"
---
