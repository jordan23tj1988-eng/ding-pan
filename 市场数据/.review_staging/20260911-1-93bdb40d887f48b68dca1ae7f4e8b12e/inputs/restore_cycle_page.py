...
if dynamic.lstrip().startswith('<div class="hero">') and '<div class="cycle-machine-inline">' in dynamic:
    ...
    kpis = '<div class="kpi"><span class="lab">涨停</span><span class="big">40</span><span class="sub2">目标日</span></div><div class="kpi"><span class="lab">温度</span><span class="big">12.7</span><span class="sub2">冰点</span></div><div class="kpi"><span class="lab">首板</span><span class="big">33</span><span class="sub2">梯队</span></div><div class="kpi"><span class="lab">最高板</span><span class="big">4</span><span class="sub2">瑞尔特</span></div>'
    # 关闭紧凑 KPI 容器、hero 与 rowA 三层；此前少关一层导致 C6 div 差1。
    dynamic = dynamic.replace('</div>\n<div class="cycle-machine-inline">', '<div class="kpis">'+kpis+'</div></div></div>\n<div class="cycle-machine-inline">', 1)
