...
ANCHORS = {
 ...
 'theme': {'THEMETICKET':'recommendations','THEMEBATTLE':'matrix','6YOU':'matrix','FOURDIM':'matrix','LIFECYCLE':'lifecycle'},
 'logic': {'LOGICTICKET':'recommendations','MACHCHAIN':'chains','MACHRADAR':'earnings','MACHHIST':'hardness'},
...
def _components(model,root):
    ...
    if route=='index':
        ...
        artifact('THEMETICKET','recommendations','题材荐票卡_'+d+'.html','题材荐票卡.py')
        ...
        artifact('LOGICTICKET','recommendations','逻辑荐票卡_'+d+'.html','逻辑荐票卡.py')
